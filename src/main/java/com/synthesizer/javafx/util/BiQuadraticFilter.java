...
public class BiQuadraticFilter {
    ...
    private double center_freq, sample_rate, Q, gainDB;

    public BiQuadraticFilter(FilterType type, double center_freq, double sample_rate, double Q, double gainDB) {
    ...
    public void configure(FilterType type, double center_freq, double sample_rate, double Q, double gainDB) {
        reset();
        Q = (Q == 0) ? 1e-9 : Q;
        this.type = type;
    ...
    public void configure(FilterType type, double center_freq, double sample_rate, double Q) {
        configure(type, center_freq, sample_rate, Q, 0);
    }
